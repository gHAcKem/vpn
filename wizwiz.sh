...
git clone https://github.com/gHAcKem/vpn.git /var/www/html/wizwizxui-timebot
...
if [ -z "$destination_dir" ]; then
 ...
 cd /var/www/html/
	 wget -O wizwizpanel.zip https://github.com/gHAcKem/vpn/releases/tag/9.1.1/wizwizpanel.zip
